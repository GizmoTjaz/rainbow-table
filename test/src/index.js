...
client.on("connect", function(connection) {
	...
	// connection.sendUTF("0,255,255|255,255,0");
	// return;
	...
	setInterval(() => {
		...
		//frame[i+1] = { r: 0, g: 255, b: 0 };
		//frame[i+2] = { r: 0, g: 0, b: 255 };
		...
		frame[i] = { r: 0, g: 255, b: 255 };

		//connection.sendUTF(`S${Math.max(0, i-1)}|0,0,0|255,0,0`);
		connection.sendUTF(serializePixelData(frame));
		//console.log(serializePixelData(frame));
